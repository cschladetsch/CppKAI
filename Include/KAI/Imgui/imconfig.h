...
// IMGUI_DISABLE_WIN32_DEFAULT_CLIPBOARD_FUNCS #define
// IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCS

//---- Don't implement help and test window functionality
//(ShowUserGuide()/ShowStyleEditor()/ShowTestWindow() methods will be empty)
