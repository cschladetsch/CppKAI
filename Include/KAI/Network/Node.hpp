...
Future<T> Node::Send(NetHandle handle, const Object &obj)
{
    ...
    unsigned char msgId = RakNet::ID_USER_PACKET_ENUM + 1; // NetworkSerializer::ID_KAI_OBJECT_MESSAGE
    ...
    if (found) {
        _peer->Send((char*)bitStream.GetData(), bitStream.GetNumberOfBytesUsed(), 
