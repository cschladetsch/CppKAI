...
int main(int argc, char **argv) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        if (arg == "--no-color") {
            ...
            // This is now redundant since color is on by default, but kept for compatibility
            SetColorOutput(true);
            ...
            std::cout << rang::fg::green << "Colored test output is enabled (default)" 
