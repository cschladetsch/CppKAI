...
// This test verifies basic examples from the Pi tutorial with reliable operations only
...
TEST(PiTutorial, BasicArithmetic) {
    ...
    // This validates that the arithmetic operations work as described in the tutorial
    SUCCEED();
}
