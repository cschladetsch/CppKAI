...
TEST_F(PiAdvancedTests, ConditionalOperations)
{
    ...
    // Nested conditionals
    AssertResult<int>("10 true { 5 + true { 2 * } { 2 / } ifelse } { 5 - } ifelse", 30);
    AssertResult<int>("10 true { 5 + false { 2 * } { 2 / } ifelse } { 5 - } ifelse", 7);
    AssertResult<int>("10 false { 5 + true { 2 * } { 2 / } ifelse } { 5 - true { 2 * } { 2 / } ifelse } ifelse", 10);
    AssertResult<int>("10 false { 5 + true { 2 * } { 2 / } ifelse } { 5 - false { 2 * } { 2 / } ifelse } ifelse", 2);
}
...
TEST_F(PiAdvancedTests, StringOperations)
{
    ...
    AssertResult<String>("\"Hello\" \"World\" \"Hello\" \"Goodbye\" == { \" Happy\" } { \" Sad\" } ifelse +", String("Hello Sad"));
    AssertResult<String>("\"Hello\" \"Hello\" \"Hello\" \"Goodbye\" == { \" Happy\" } { \" Sad\" } ifelse +", String("Hello Happy"));
}
...
TEST_F(PiAdvancedTests, VariableOperations)
{
    ...
    AssertResult<int>("5 'x' ! 10 'y' ! 'x' @ 'y' @ < { 'x' @ 2 * } { 'y' @ 2 * } ifelse", 20);
    AssertResult<int>("15 'x' ! 10 'y' ! 'x' @ 'y' @ < { 'x' @ 2 * } { 'y' @ 2 * } ifelse", 30);
}
...
TEST_F(PiAdvancedTests, ControlFlowOperations)
{
    ...
    AssertResult<int>("0 'sum' ! 1 'i' ! begin 'i' @ 'sum' +! 'i' @ 1 + 'i' ! 'i' @ 5 <= while repeat 'sum' @", 15);
    
    // Using begin-until (sum from 1 to 5)
    AssertResult<int>("0 'sum' ! 1 'i' ! begin 'i' @ 'sum' +! 'i' @ 1 + 'i' ! 'i' @ 5 > until 'sum' @", 15);
