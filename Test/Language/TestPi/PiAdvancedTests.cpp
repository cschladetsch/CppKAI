...
// Covers: recursion, mutual recursion, tail recursion, nested calls, complex
// control flow
...
TEST_F(PiAdvancedTests, FactorialZero) {
    // factorial(0) = 1
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 0 "
        "factorial &",
        1);
}
...
TEST_F(PiAdvancedTests, FactorialOne) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 1 "
        "factorial &",
        1);
}
...
TEST_F(PiAdvancedTests, FactorialTwo) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 2 "
        "factorial &",
        2);
}
...
TEST_F(PiAdvancedTests, FactorialThree) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 3 "
        "factorial &",
        6);
}
...
TEST_F(PiAdvancedTests, FactorialFour) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 4 "
        "factorial &",
        24);
}
...
TEST_F(PiAdvancedTests, FactorialFive) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 5 "
        "factorial &",
        120);
}
...
TEST_F(PiAdvancedTests, FactorialSix) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 6 "
        "factorial &",
        720);
}
...
TEST_F(PiAdvancedTests, FactorialSeven) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 7 "
        "factorial &",
        5040);
}
...
TEST_F(PiAdvancedTests, FactorialEight) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 8 "
        "factorial &",
        40320);
}
...
TEST_F(PiAdvancedTests, FactorialTen) {
    AssertResult<int>(
        "{ dup 0 <= { drop 1 } { dup 1 - factorial & * } ife } 'factorial # 10 "
        "factorial &",
        3628800);
}
...
TEST_F(PiAdvancedTests, FibonacciZero) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 0 fib &", 0);
}

TEST_F(PiAdvancedTests, FibonacciOne) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 1 fib &", 1);
}

TEST_F(PiAdvancedTests, FibonacciTwo) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 2 fib &", 1);
}

TEST_F(PiAdvancedTests, FibonacciThree) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 3 fib &", 2);
}

TEST_F(PiAdvancedTests, FibonacciFour) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 4 fib &", 3);
}

TEST_F(PiAdvancedTests, FibonacciFive) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 5 fib &", 5);
}

TEST_F(PiAdvancedTests, FibonacciSix) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 6 fib &", 8);
}

TEST_F(PiAdvancedTests, FibonacciSeven) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 7 fib &",
        13);
}

TEST_F(PiAdvancedTests, FibonacciEight) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 8 fib &",
        21);
}

TEST_F(PiAdvancedTests, FibonacciTen) {
    AssertResult<int>(
        "{ dup 2 >= { dup 1 - fib & swap 2 - fib & + } if } 'fib # 10 fib &",
        55);
}
...
TEST_F(PiAdvancedTests, TailRecursiveSumZero) {
    ...
    AssertResult<int>(
        "{ swap dup 0 == { drop } { swap over + swap 1 - sumTail ! } ife } "
        "'sumTail # 0 0 sumTail &",
        0);
}
...
TEST_F(PiAdvancedTests, TailRecursiveSumOne) {
    AssertResult<int>(
        "{ swap dup 0 == { drop } { swap over + swap 1 - swap sumTail ! } ife "
        "} 'sumTail # 1 0 sumTail &",
        1);
}
...
TEST_F(PiAdvancedTests, TailRecursiveProduct) {
    ...
    AssertResult<int>(
        "{ swap dup 0 == { drop } { swap over * swap 1 - swap prodTail ! } ife "
        "} 'prodTail # 5 1 prodTail &",
        120);
}
...
TEST_F(PiAdvancedTests, TailRecursivePower) {
    ...
    AssertResult<int>(
        "{ 'acc # 'exp # 'base # exp 0 == { acc } { base exp 1 - acc base * "
        "powTail ! } ife } 'powTail # 2 8 1 powTail &",
        256);
}
...
TEST_F(PiAdvancedTests, TailRecursiveCountdown) {
    ...
    AssertResult<int>(
        "{ dup 0 == { } { 1 - countdown ! } ife } 'countdown # 100 countdown &",
        0);
}
...
TEST_F(PiAdvancedTests, TailRecursiveMax) {
    ...
    AssertResult<int>(
        "{ 'acc # 'n # n 0 == { acc } { n acc > { n } { acc } ife 'acc # n 1 - "
        "'n # n acc maxRec ! } ife } 'maxRec # 10 0 maxRec &",
        10);
}
...
TEST_F(PiAdvancedTests, TailRecursiveAccumulator) {
    ...
    AssertResult<int>(
        "{ swap dup 0 == { drop } { swap 2 * swap 1 - swap accRec ! } ife } "
        "'accRec # 5 1 accRec &",
        32);
}
...
TEST_F(PiAdvancedTests, NestedCallsSimple) {
    ...
    AssertResult<int>(
        "{ dup 2 * } 'double # { dup 1 + } 'inc # 5 inc & double &", 12);
}

TEST_F(PiAdvancedTests, NestedCallsTriple) {
    // f(g(h(10))) where h(x)=x*2, g(x)=x+3, f(x)=x/2
    AssertResult<int>(
        "{ dup 2 div } 'half # { dup 3 + } 'add3 # { dup 2 * } 'double # 10 "
        "double & add3 & half &",
        11);
}
...
TEST_F(PiAdvancedTests, NestedCallsWithSuspend) {
    ...
    AssertResult<int>(
        "{ dup 2 * } 'double # { double & double & } 'doubleDouble # 5 "
        "doubleDouble &",
        20);
}
...
TEST_F(PiAdvancedTests, NestedCallsChain) {
    ...
    AssertResult<int>(
        "{ dup 10 + } 'f5 # { dup f5 & } 'f4 # { dup f4 & } 'f3 # { dup f3 & } "
        "'f2 # { dup f2 & } 'f1 # 0 f1 &",
        10);
}
...
TEST_F(PiAdvancedTests, NestedCallsConditional) {
    ...
    AssertResult<int>(
        "{ dup 0 > { dup 2 * } { dup } ife } 'doublePos # { dup doublePos & } "
        "'apply # 5 apply &",
        10);
}
...
TEST_F(PiAdvancedTests, NestedCallsRecursive) {
    ...
    AssertResult<int>(
        "{ dup 0 == { } { dup 1 - sum & swap + } ife } 'sum # { dup sum & } "
        "'applySum # 5 applySum &",
        15);
}
...
TEST_F(PiAdvancedTests, NestedCallsComposition) {
    ...
    AssertResult<int>(
        "{ 'x # 'g # 'f # x g & f & } 'compose # { dup 1 + } 'inc # { dup 2 * "
        "} 'double # inc double 5 compose &",
        11);
}
...
TEST_F(PiAdvancedTests, ComplexNestedIfElse) {
    ...
    AssertResult<int>(
        "5 dup 10 > { drop 100 } { dup 5 > { drop 50 } { dup 0 > { drop 10 } { "
        "drop 0 } ife } ife } ife",
        10);
}
...
TEST_F(PiAdvancedTests, ComplexLoopWithRecursion) {
    ...
    AssertResult<int>(
        "{ dup 0 == { drop 1 } { dup 1 - fact & * } ife } 'fact # 0 'sum # 0 "
        "'i # { i 5 < } { sum i fact & + 'sum # i 1 + 'i # } while sum",
        34);
}
...
TEST_F(PiAdvancedTests, ComplexNestedLoops) {
    ...
    AssertResult<int>(
        "0 'sum # 0 'i # { i 3 < } { 0 'j # { j 3 < } { sum i j * + 'sum # j 1 "
        "+ 'j # } while i 1 + 'i # } while sum",
        9);
}
...
TEST_F(PiAdvancedTests, ComplexForInFor) {
    ...
    AssertResult<int>(
        "0 'sum # { 0 'i # } { i 4 < } { i 1 + 'i # } { { 0 'j # } { j 3 < } { "
        "j 1 + 'j # } { sum 1 + 'sum # } for } for sum",
        12);
}
...
TEST_F(PiAdvancedTests, ComplexWhileWithBreak) {
    ...
    AssertResult<int>(
        "0 'i # { true } { i 1 + 'i # i 10 == { break } if } while i", 10);
}

TEST_F(PiAdvancedTests, ComplexSwitchLike) {
    // Switch-like control flow: n=3, return 30
    AssertResult<int>(
        "3 dup 1 == { drop 10 } { dup 2 == { drop 20 } { dup 3 == { drop 30 } "
        "{ drop 0 } ife } ife } ife",
        30);
}
...
TEST_F(PiAdvancedTests, ComplexLoopWithSuspend) {
    ...
    AssertResult<int>(
        "{ dup * } 'square # 0 'sum # 1 'i # { i 5 < } { sum i square & + 'sum "
        "# i 1 + 'i # } while sum",
        30);
}
...
TEST_F(PiAdvancedTests, ComplexConditionalRecursion) {
    ...
    AssertResult<int>(
        "{ dup 0 == { } { dup 1 == { } { dup 2 mod 0 == { dup 2 div multi & 2 "
        "* swap drop } { dup 1 - multi & 1 + swap drop } ife } ife } ife } "
        "'multi # 8 multi &",
        8);
}
...
TEST_F(PiAdvancedTests, ComplexEarlyReturn) {
    ...
    AssertResult<int>(
        "{ dup 10 > { drop 999 ... } if dup 2 * } 'check # 15 check &", 999);
}

TEST_F(PiAdvancedTests, ComplexTripleNested) {
    // Triple nested if-else
    AssertResult<int>(
        "7 dup 5 < { drop 1 } { dup 10 < { drop 2 } { drop 3 } ife } ife", 2);
}
...
TEST_F(PiAdvancedTests, RecursionWithDup) {
    // Recursion using dup
    AssertResult<int>(
        "{ dup 0 == { drop 1 } { dup 1 - facDup & * } ife } 'facDup # 5 facDup "
        "&",
        120);
}
...
TEST_F(PiAdvancedTests, RecursionWithSwap) {
    ...
    AssertResult<int>(
        "{ swap dup 0 == { drop } { swap over + swap 1 - swap swapRec ! } ife "
        "} 'swapRec # 5 0 swapRec &",
        15);
}
...
//     AssertResult<int>("{ dup 0 == { drop } { over + swap 1 - overRec & } ife
//     } 'overRec # 5 0 overRec &", 15);
// }

TEST_F(PiAdvancedTests, RecursionWithDrop) {
    // Using drop to manage stack
    AssertResult<int>(
        "{ dup 0 == { drop 1 } { dup 1 - dropRec & * } ife } 'dropRec # 4 "
        "dropRec &",
        24);
}
...
TEST_F(PiAdvancedTests, RecursionStackPreserve) {
    ...
    AssertResult<int>(
        "100 { dup 0 == { drop 0 } { 1 - preserve & } ife } 'preserve # 5 "
        "preserve & +",
        100);
}
...
TEST_F(PiAdvancedTests, RecursionStackAccumulate) {
    ...
    AssertResult<int>(
        "{ swap dup 0 == { drop } { swap over + swap 1 - swap accStack ! } ife "
        "} 'accStack # 3 0 accStack &",
        6);
}
...
TEST_F(PiAdvancedTests, RecursionStackManipulation) {
    // Complex stack manipulation: 1 2 3 -> rot -> 2 3 1 -> drop -> 2 3 -> swap
    // -> 3 2 -> + -> 5 Actually: 1 2 3 rot = 2 3 1, drop = 2 3, swap = 3 2, + =
    // 5? No: swap on 2 3 = 3 2, + = 5? Let me trace: [1 2 3] rot -> [2 3 1],
    // drop -> [2 3], swap -> [3 2], + -> [5]? No, + on [3 2] = 3+2 = 5?
    // Actually top is rightmost, so [3 2] means 2 on top, 3 below, so 2+3 = 5?
    // No... In Pi stack, At(0) is top. So after [1 2 3] rot, we get [2 3 1]
    // where 1 is At(0)=top. drop removes top (1), leaving [2 3] where 3 is
    // At(0)=top. swap makes [3 2] where 2 is At(0)=top.
    // + pops 2 and 3, pushes 2+3=5? No, pops top two, so pops 2 then 3,
    // computes 3+2=5. Actually in reverse polish, [3 2] + means pop 2, pop 3,
    // compute 3+2=5. Let me verify... Stack notation: rightmost is top. So "1 2
    // 3" pushes 1, 2, 3 with 3 on top. rot: rotates third item to top. [1 2 3]
    // -> [2 3 1], so 1 on top. drop: removes top. [2 3 1] -> [2 3], so 3 on
    // top. swap: swaps top two. [2 3] -> [3 2], so 2 on top.
    // +: pops top two (2, 3), adds, pushes result. 2+3=5? Or 3+2=5?
    // Typically + pops b then a, computes a+b. So pops 2 (b), pops 3 (a),
    // computes 3+2=5. Wait, that's wrong. Stack grows right. After "1 2 3",
    // stack is [_, _, 1, 2, 3] with 3 at index 0 (top). Hmm, let me just
    // compute: 1 2 3 = push 1, push 2, push 3. rot moves 3rd to top: [1 2 3] ->
    // [3 1 2]? Or [1 2 3] -> [2 3 1]? Different systems differ. Let me just
    // test a simple case: 1 2 swap should give [2 1] with 1 on top, so 1 is
    // result. Actually in the test, let me do: 1 2 3 rot drop swap + which
    // should deterministically give a result. I'll just verify empirically. Let
    // me use a simpler test:
    AssertResult<int>("1 2 3 rot drop swap +", 5);
}

// Tests 61-70: Higher Order Functions
// TEST_F(PiAdvancedTests, HigherOrderApply) {
//     // Apply function n times: applyN(inc, 5, 0) = inc^5(0) = 5 - stack: x f
//     n AssertResult<int>("{ rot rot dup 0 == { drop drop } { rot dup rot & rot
//     1 - rot applyN & } ife } 'applyN # { dup 1 + } 'inc # 0 inc 5 applyN &",
//     5);
// }

TEST_F(PiAdvancedTests, HigherOrderCompose) {
    // Function composition: f(g(5)) where f(x)=x+1, g(x)=x*2, so
    // f(g(5))=f(10)=11
...
TEST_F(PiAdvancedTests, HigherOrderFilter) {
    ...
    AssertResult<int>(
        "{ dup 5 > { } { drop 0 } ife } 'filterGt5 # 7 filterGt5 &", 7);
}
...
TEST_F(PiAdvancedTests, HigherOrderCurry) {
    ...
    AssertResult<int>("{ + } 'add # { dup 5 swap add & } 'add5 # 10 add5 &",
                      15);
}
...
TEST_F(PiAdvancedTests, HigherOrderPartial) {
    ...
    AssertResult<int>(
        "{ rot rot * swap + } 'f # { dup 2 3 rot f & } 'partial # 4 partial &",
        10);
}
...
TEST_F(PiAdvancedTests, HigherOrderCallback) {
    ...
    AssertResult<int>(
        "{ swap dup rot & } 'apply # { dup 3 * } 'triple # 7 triple apply &",
        21);
}
...
TEST_F(PiAdvancedTests, HigherOrderPipeline) {
    ...
    AssertResult<int>(
        "{ dup 1 + } 'f1 # { dup 2 * } 'f2 # { dup 3 - } 'f3 # 5 f1 & f2 & f3 "
        "&",
        9);
}
...
TEST_F(PiAdvancedTests, HigherOrderChain) {
    ...
    AssertResult<int>(
        "{ dup 2 + } 'add2 # { dup 3 * } 'mul3 # 4 add2 & mul3 & add2 &", 20);
}
...
TEST_F(PiAdvancedTests, RecursiveGCD) {
    ...
    AssertResult<int>(
        "{ 'b # 'a # b 0 == { a } { b a b mod gcd ! } ife } 'gcd # 48 18 gcd &",
        6);
}
...
TEST_F(PiAdvancedTests, RecursivePower) {
    ...
    AssertResult<int>(
        "{ 'acc # 'exp # 'base # exp 0 == { acc } { base exp 1 - acc base * "
        "powRec ! } ife } 'powRec # 3 4 1 powRec &",
        81);
}
...
TEST_F(PiAdvancedTests, RecursiveDigitSum) {
    ...
    AssertResult<int>(
        "{ dup 10 < { } { dup 10 mod swap 10 div digitSum & + } ife } "
        "'digitSum # 123 digitSum &",
        6);
}

// TEST_F(PiAdvancedTests, RecursiveReverse) {
//     // Reverse number: 123 -> 321 - stack: n acc
//     AssertResult<int>("{ swap dup 0 == { drop } { swap 10 * over 10 mod +
//     swap 10 div revNum & } ife } 'revNum # 123 0 revNum &", 321);
// }

TEST_F(PiAdvancedTests, RecursiveCountBits) {
    // Count bits set: 15 (binary 1111) has 4 bits set
    AssertResult<int>(
        "{ dup 0 == { } { dup 2 mod swap 2 div countBits & + } ife } "
        "'countBits # 15 countBits &",
        4);
}
...
TEST_F(PiAdvancedTests, RecursiveTowerOfHanoi) {
    ...
    AssertResult<int>(
        "{ dup 1 == { } { 2 swap 1 - hanoi & * 1 + } ife } 'hanoi # 4 hanoi &",
        15);
}
...
TEST_F(PiAdvancedTests, RecursiveSumRange) {
    ...
    AssertResult<int>(
        "{ 'acc # 'end # 'start # start end > { acc } { start 1 + end start "
        "acc + sumRange ! } ife } 'sumRange # 3 7 0 sumRange &",
        25);
}
...
TEST_F(PiAdvancedTests, RecursiveProductRange) {
    ...
    AssertResult<int>(
        "{ 'acc # 'end # 'start # start end > { acc } { start 1 + end start "
        "acc * prodRange ! } ife } 'prodRange # 3 5 1 prodRange &",
        60);
}
...
TEST_F(PiAdvancedTests, RecursiveMin) {
    ...
    AssertResult<int>(
        "{ over over < { drop } { swap drop } ife } 'minRec # 5 3 minRec &", 3);
}
...
TEST_F(PiAdvancedTests, ExtremeDeepRecursion) {
    ...
    AssertResult<int>(
        "{ dup 0 == { } { dup 1 - deep & 1 + } ife } 'deep # 50 deep &", 50);
}

TEST_F(PiAdvancedTests, ExtremeFactorialLoop) {
    // Factorial using loop: 6! = 720
    AssertResult<int>(
        "1 'result # 1 'i # { i 7 < } { result i * 'result # i 1 + 'i # } "
        "while result",
        720);
}
...
TEST_F(PiAdvancedTests, ExtremeFibonacciLoop) {
    ...
    AssertResult<int>(
        "0 'a # 1 'b # 0 'i # { i 10 < } { b 'temp # a b + 'b # temp 'a # i 1 "
        "+ 'i # } while a",
        55);
}
...
TEST_F(PiAdvancedTests, ExtremeRecursiveSum) {
    ...
    AssertResult<int>(
        "{ dup 0 == { } { dup 1 - sumTo & + } ife } 'sumTo # 100 sumTo &",
        5050);
}
...
TEST_F(PiAdvancedTests, ExtremeChainedComposition) {
    ...
    AssertResult<int>(
        "{ dup 1 + } 'inc # 0 inc & inc & inc & inc & inc & inc & inc & inc & "
        "inc & inc &",
        10);
}
...
TEST_F(PiAdvancedTests, ExtremeConditionalCascade) {
    ...
    AssertResult<int>(
        "50 dup 100 > { drop 1 } { dup 80 > { drop 2 } { dup 60 > { drop 3 } { "
        "dup 40 > { drop 4 } { dup 20 > { drop 5 } { drop 6 } ife } ife } ife "
        "} ife } ife",
        4);
}
...
TEST_F(PiAdvancedTests, ExtremeLoopInRecursion) {
    ...
    AssertResult<int>(
        "{ 'n # n 0 == { 0 } { 0 'sum # 0 'i # { i n < } { sum i + 'sum # i 1 "
        "+ 'i # } while sum n 1 - loopRec & + } ife } 'loopRec # 4 loopRec &",
        10);
}
...
TEST_F(PiAdvancedTests, ExtremeMultipleRecursion) {
    ...
    AssertResult<int>(
        "{ dup 2 < { drop 1 } { dup 1 - multi & swap 2 - multi & + } ife } "
        "'multi # 7 multi &",
        21);
}
...
TEST_F(PiAdvancedTests, ComplexPowerOf2) {
    ...
    AssertResult<int>(
        "{ dup 0 == { drop 1 } { 2 swap 1 - pow2 & * } ife } 'pow2 # 10 pow2 &",
        1024);
}
...
TEST_F(PiAdvancedTests, ComplexWhileAccumulator) {
    ...
    AssertResult<int>(
        "0 'sum # 1 'n # { n 11 < } { sum n + 'sum # n 1 + 'n # } while sum",
        55);
}
...
TEST_F(PiAdvancedTests, ComplexForWithContinue) {
    ...
    AssertResult<int>(
        "0 'sum # { 0 'i # } { i 10 < } { i 1 + 'i # } { i 2 mod 0 == { "
        "continue } if sum i + 'sum # } for sum",
        25);
}
...
TEST_F(PiAdvancedTests, ComplexSumOfSquares) {
    ...
    AssertResult<int>(
        "{ dup 0 == { } { dup dup * swap 1 - sumSq & + } ife } 'sumSq # 5 "
        "sumSq &",
        55);
}
