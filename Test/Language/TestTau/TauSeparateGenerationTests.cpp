...
TEST_F(TauSeparateGenerationTests, TestProxyOnlyGeneratesProxy) {
    ...
    EXPECT_TRUE(output.find("class ServiceProxy: public ProxyBase") != string::npos);
...
TEST_F(TauSeparateGenerationTests, TestAgentOnlyGeneratesAgent) {
    ...
    EXPECT_TRUE(output.find("class ServiceAgent: public AgentBase<Service>") != string::npos);
...
TEST_F(TauSeparateGenerationTests, TestProxyHandlesInterfaces) {
    ...
    EXPECT_TRUE(output.find("class ILoggerProxy: public ProxyBase") != string::npos);
...
TEST_F(TauSeparateGenerationTests, TestAgentHandlesInterfaces) {
    ...
    EXPECT_TRUE(output.find("class ILoggerAgent: public AgentBase<ILogger>") != string::npos);
...
TEST_F(TauSeparateGenerationTests, TestComplexScenario) {
    ...
    // Test proxy generation
    {
        ...
        EXPECT_TRUE(proxyOutput.find("class IUserServiceProxy") != string::npos);
        ...
        EXPECT_TRUE(proxyOutput.find("RegisterOnUserAddedHandler") != string::npos);
    }
    ...
    // Test agent generation
    {
        ...
        EXPECT_TRUE(agentOutput.find("class IUserServiceAgent") != string::npos);
