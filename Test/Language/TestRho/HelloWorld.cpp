...
// Simple standalone test for Rho language that doesn't use any do-while constructs
TEST(RhoMinimal, HelloWorld) {
    ...
    try {
        ...
        try {
            ...
            FAIL() << "Test failed with exception during execution: " << e.ToString();
        }
        catch(const std::exception& e) {
            cerr << "Standard exception during execution: " << e.what() << endl;
            FAIL() << "Test failed with standard exception during execution: " << e.what();
        }
