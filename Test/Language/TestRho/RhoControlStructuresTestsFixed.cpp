...
// Fixture for testing Rho control structures with correct syntax
...
TEST_F(RhoControlTestsFixed, BasicIfStatements) {
...
TEST_F(RhoControlTestsFixed, IfElseStatements) {
    AssertDirectSimulation<int>(
        "result = 0\n"
        "if true\n"
        "    result = 42\n"
...
TEST_F(RhoControlTestsFixed, BasicWhileLoops) {
    AssertDirectSimulation<int>(
        "sum = 0\n"
        "i = 1\n"
        "while i <= 5\n"
...
TEST_F(RhoControlTestsFixed, BasicForLoops) {
    AssertDirectSimulation<int>(
        "sum = 0\n"
        "for i = 1; i <= 5; i = i + 1\n"
        "    sum = sum + i\n"
...
TEST_F(RhoControlTestsFixed, DoWhileLoops) {
    AssertDirectSimulation<int>(
        "sum = 0\n"
        "i = 1\n"
        "do\n"
...
// Debug nested if parsing issues
TEST_F(RhoControlTestsFixed, DebugNestedIfParsing) {
...
TEST_F(RhoControlTestsFixed, ComplexConditions) {
    AssertDirectSimulation<int>(
        "result = 0\n"
        "if 5 > 3 && 10 < 20\n"
        "    result = 42\n"
