...
struct RhoAdvancedTests : TestLangCommon {
    // Helper method to execute a Rho script and verify the value on top of
    // stack
    template <class T>
...
TEST_F(RhoAdvancedTests, ComplexStringOperations) {
    AssertResult<String>("\"prefix-\" + (\"middle\" + \"-suffix\")",
...
TEST_F(RhoAdvancedTests, StringNumberOperations) {
    AssertResult<String>("\"The answer is: \" + (40 + 2)",
