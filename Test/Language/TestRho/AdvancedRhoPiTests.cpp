...
TEST(RhoPiAdvanced, LogicalAnd) {
    ...
    Object result1 = exec->PerformBinaryOp(valueTrue, valueFalse, Operation::LogicalAnd);
    ...
    // Execute logical AND operation directly using our improved PerformBinaryOp
    Object result2 = exec->PerformBinaryOp(valueTrue, valueTrue2, Operation::LogicalAnd);
...
TEST(RhoPiAdvanced, LogicalOr) {
    ...
    Object result1 = exec->PerformBinaryOp(valueFalse, valueTrue, Operation::LogicalOr);
    ...
    // Execute logical OR operation directly using our improved PerformBinaryOp
    Object result2 = exec->PerformBinaryOp(valueFalse, valueFalse2, Operation::LogicalOr);
...
TEST(RhoPiAdvanced, LessThanOrEqualComparison) {
    ...
    // Execute less than or equal comparison directly using our improved PerformBinaryOp
...
TEST(RhoPiAdvanced, GreaterThanOrEqualComparison) {
    ...
    // Execute greater than or equal comparison directly using our improved PerformBinaryOp
    Object result1 = exec->PerformBinaryOp(ten, five, Operation::GreaterOrEquiv);
    ...
    // Execute greater than or equal comparison directly using our improved PerformBinaryOp
    Object result2 = exec->PerformBinaryOp(five, five2, Operation::GreaterOrEquiv);
    ...
    // Execute greater than or equal comparison directly using our improved PerformBinaryOp
    Object result3 = exec->PerformBinaryOp(five, ten, Operation::GreaterOrEquiv);
