...
int main() {
    ...
    std::cout << "✓ Method.h compiles with unique_ptr<MethodBase> return type\n";
    std::cout << "✓ Accessor.h compiles with unique_ptr<PropertyBase> return type\n";
    ...
    std::cout << "\nHeader changes successful! Smart pointer migration in progress.\n";
    return 0;
}