...
struct ChatMessage {
    ...
    ChatMessage(const std::string& ch, const std::string& s, const std::string& c)
...
public:
    ...
    bool CreateChannel(const std::string& channelName) {
        ...
        std::cout << "[" << username_ << "] Created channel: " << channelName << std::endl;
        return true;
    }
    ...
    bool JoinChannel(const std::string& channelName) {
        ...
        std::cout << "[" << username_ << "] Joined channel: " << channelName << std::endl;
        return true;
    }
    ...
    void SendMessage(const std::string& message) {
        if (currentChannel_.empty()) {
            std::cout << "[" << username_ << "] Error: Not in a channel!" << std::endl;
            return;
        }
        ...
        std::cout << "[" << currentChannel_ << "] " << username_ << ": " << message << std::endl;
    }
    
    // Leave current channel
    void LeaveChannel() {
        if (!currentChannel_.empty()) {
            std::cout << "[" << username_ << "] Left channel: " << currentChannel_ << std::endl;
    ...
    void ShowHistory() {
        ...
        for (const auto& msg : messages_) {
            std::cout << "[" << msg.channel << "] " << msg.sender << ": " << msg.content << std::endl;
        }
        std::cout << "=====================\n\n";
    }
};
