...
TEST_F(ColorOutputExample, DemonstrateColors) {
    ...
    std::cout << rang::fg::green << "[INFO] This is an INFO message (green)" << rang::fg::reset << std::endl;
    std::cout << rang::fg::yellow << "[WARNING] This is a WARNING message (yellow)" << rang::fg::reset << std::endl;
    std::cout << rang::fg::red << "[ERROR] This is an ERROR message (red)" << rang::fg::reset << std::endl;
...
int main(int argc, char **argv) {
    ...
    std::cout << "This example demonstrates the colored output functionality." << std::endl;
