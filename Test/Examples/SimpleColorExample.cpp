...
int main() {
    ...
    std::cout << "This example demonstrates colored terminal output with rang." << std::endl;
    std::cout << std::endl;

    // Basic foreground colors
    std::cout << rang::fg::green << "This is green text" << rang::fg::reset << std::endl;
    std::cout << rang::fg::red << "This is red text" << rang::fg::reset << std::endl;
    std::cout << rang::fg::yellow << "This is yellow text" << rang::fg::reset << std::endl;
    std::cout << rang::fg::blue << "This is blue text" << rang::fg::reset << std::endl;
    std::cout << rang::fg::magenta << "This is magenta text" << rang::fg::reset << std::endl;
    std::cout << rang::fg::cyan << "This is cyan text" << rang::fg::reset << std::endl;
    std::cout << rang::fg::gray << "This is gray text" << rang::fg::reset << std::endl;
    std::cout << std::endl;

    // Text styles
    std::cout << rang::style::bold << "This is bold text" << rang::style::reset << std::endl;
    std::cout << rang::style::italic << "This is italic text" << rang::style::reset << std::endl;
    ...
    std::cout << rang::bg::blue << rang::fg::cyan 
              << "This is cyan text on blue background" 
              << rang::bg::reset << rang::fg::reset << std::endl;
    std::cout << std::endl;
    ...
    std::cout << rang::fg::red << rang::style::bold << "[ERROR] " << rang::style::reset << rang::fg::reset
