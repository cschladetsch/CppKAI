...
{
    // Rendering
    int fb_width = (int)(ImGui::GetIO().DisplaySize.x * ImGui::GetIO().DisplayFramebufferScale.x);
    int fb_height = (int)(ImGui::GetIO().DisplaySize.y * ImGui::GetIO().DisplayFramebufferScale.y);
...
int main(int argc, char **argv) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Show settings window with ImGui demo toggle
        {
            ...
            if (ImGui::Button("ImGui Demo")) show_demo_window = !show_demo_window;
