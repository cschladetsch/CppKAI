// dear imgui: Renderer for OpenGL3 / OpenGL ES2 / OpenGL ES3 (modern OpenGL
// with shaders / programmatic pipeline) This needs to be used along with a
// Platform Binding (e.g. GLFW, SDL, Win32, custom..) (Note: We are using GL3W
// as a helper library to access OpenGL functions since there is no standard
// header to access modern OpenGL functions easily. Alternatives are GLEW, Glad,
// etc..)
...
//  in the About Window. 2018-11-13: OpenGL: Support for GL 4.5's
//  glClipControl(GL_UPPER_LEFT). 2018-08-29: OpenGL: Added support for more
//  OpenGL loaders: glew and glad, with comments indicative that any loader can
//  be used. 2018-08-09: OpenGL: Default to OpenGL ES 3 on iOS and Android. GLSL
//  version default to "#version 300 ES". 2018-07-30: OpenGL: Support for GLSL
//  300 ES and 410 core. Fixes for Emscripten compilation. 2018-07-10: OpenGL:
//  Support for more GLSL versions (based on the GLSL version string). Added
//  error output when shaders fail to compile/link. 2018-06-08: Misc: Extracted
                ...
                if (clip_rect.x < fb_width && clip_rect.y < fb_height &&
                    ...
                    if (clip_origin_lower_left)
                        ...
                        glScissor(
                            ...
                            (int)clip_rect.z,
                            (int)clip_rect.w);  // Support for GL 4.5's
                                                // glClipControl(GL_UPPER_LEFT)
