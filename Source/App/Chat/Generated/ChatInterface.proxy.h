...
namespace KAI { namespace Demo { namespace Chat
{
    class IChatPeerProxy: public ProxyBase
    {
        ...
        void ForwardMessage(const ChatMessage& message, const string[]& excludePeers)
        {
            RakNet::BitStream args;
            args << message;
            args << excludePeers;
        ...
        void JoinChannelRequest(const string& channelName, const PeerInfo& peerInfo)
        {
            RakNet::BitStream args;
            args << channelName;
            args << peerInfo;
        ...
        void LeaveChannelNotification(const string& channelName, const string& peerId)
        {
            RakNet::BitStream args;
            args << channelName;
            args << peerId;
        ...
        void RegisterMessageReceivedHandler(std::function<void(ChatMessage)> handler)
        {
        ...
        void RegisterPrivateMessageReceivedHandler(std::function<void(ChatMessage)> handler)
        {
        ...
        void UnregisterPeerJoinedHandler()
        {
            UnregisterEventHandler("PeerJoined");
        }
        ...
        void UnregisterPeerLeftHandler()
        {
            UnregisterEventHandler("PeerLeft");
        }

        void RegisterPeerStatusUpdatedHandler(std::function<void(string, string)> handler)
        {
        ...
        void RegisterChannelMembershipChangedHandler(std::function<void(string, string[])> handler)
        {
        ...
        void RegisterChannelCreatedHandler(std::function<void(ChannelState)> handler)
        {
    ...
    class IChatManagerProxy: public ProxyBase
    {
        ...
        {
            _node->Send("RefreshPeerList");
        }

        // Network operations
        void StartNetworking()
        {
            _node->Send("StartNetworking");
        }

        void StopNetworking()
        {
            _node->Send("StopNetworking");
        }
        ...
        // Event registration methods
        void RegisterNetworkStatusChangedHandler(std::function<void(bool)> handler)
        {
        ...
        void RegisterChannelListUpdatedHandler(std::function<void(string[])> handler)
        {
        ...
        void RegisterPeerListUpdatedHandler(std::function<void(PeerInfo[])> handler)
        {
